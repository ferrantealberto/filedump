<?php
/**
 * Plugin Name: WhatsApp SaaS Pro MT
 * Plugin URI: https://wapower.it
 * Description: Sistema SaaS completo multi-tenant per campagne WhatsApp con Mail2Wa, QR Code, Report automatici e gestione piani
 * Version: 4.2.0
 * Author: WaPower Team
...
class WhatsAppSaasPluginPro {
    ...
    private function load_dependencies() {
        // Carica il loader per compatibilità
        require_once WSP_PLUGIN_DIR . 'includes/class-wsp-loader.php';
        // Classi core esistenti - carica solo se esistono
        $core_classes = array(
            'includes/class-wsp-database.php',
            'includes/class-wsp-settings.php',
            'includes/class-wsp-api.php',
            'includes/class-wsp-mail2wa.php',
            'includes/class-wsp-messages.php',
            'includes/class-wsp-campaigns.php',
            'includes/class-wsp-credits.php',
            'includes/class-wsp-gmail.php',
            'includes/class-wsp-migration.php',
            'includes/class-wsp-test.php',
            'includes/class-wsp-sample-data.php'
        );
        
        foreach ($core_classes as $class_file) {
            if (file_exists(WSP_PLUGIN_DIR . $class_file)) {
                require_once WSP_PLUGIN_DIR . $class_file;
            }
        }
